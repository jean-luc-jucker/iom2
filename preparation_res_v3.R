# Main difference from v2: we now do the merge ourselves.
...
# Mimosa data (mimosa)
mimosa <- read_excel('data_raw/MIMOSA Reint Cases M&E-eco.xlsx',
                     na = c('N/A', 'NA', 'na', 'NULL'))
dim(mimosa) # 222,379 x 12

# Reintegration Economic Survey (kobo) ####
kobo <- read_excel('data_raw/RE_Economic_Survey_clean for data analysis.xlsx',
                   na = c('N/A', 'NA', 'na')) 
