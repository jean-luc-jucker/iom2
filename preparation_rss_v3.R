# Main change from v2: we use yet new cleaned data (received 15 June 2023 from
# client), and still do the merge ourselves.
...
mutate(`1_economic_n` =
       ...
       # Construct of the above 2 measures
       #`29_30_remigration` = `29_able_to_stay_n` + `30_wish_vs_need_leave_n`
       
       
       
       
       
       # also some na, see below
...
mutate(`5_debt_ratio_n` = replace_na(`5_debt_ratio_n`, 0.5), # Read Note 2! # previously 1!!!!!!!!!!
       ...
       # Psycho social
       `30_wish_vs_need_leave_n` = replace_na(`30_wish_vs_need_leave_n`, 0) # Read Note X!
...
mutate(# Construct of the above 2 measures
  `29_30_remigration_construct` = `29_able_to_stay_n` + `30_wish_vs_need_leave_n`
...
length(intersect(kobo_slim$`Code Mimosa Corrigé`, mimosa_slim$`CaseNo/IndividualNo`)) # 1,196
# Previously: 1,189
# Common IDs between Code Mimosa Corrigé and CaseNo
length(intersect(kobo_slim$`Code Mimosa Corrigé`, mimosa_slim$CaseNo)) # 889
# Previously: 881
# Common IDs between Code Mimosa Corrigé and MemberNo
length(intersect(kobo_slim$`Code Mimosa Corrigé`, mimosa_slim$MemberNo)) # 307 NOTE, 889 + 307 = 1,196
# Previously: 308  NOTE, 881 + 308 = 1,189
...
length(intersect(kobo_slim$`Identifiant MiMOSA du cas`, mimosa_slim$`CaseNo/IndividualNo`)) # 1,131
# Previously: 1,110
# Common IDs between Identifiant MiMOSA du cas and CaseNo
length(intersect(kobo_slim$`Identifiant MiMOSA du cas`, mimosa_slim$CaseNo)) # 841
# Previously: 820
# Common IDs between Identifiant MiMOSA du cas and MemberNo
length(intersect(kobo_slim$`Identifiant MiMOSA du cas`, mimosa_slim$MemberNo)) # 290 NOTE, 290 + 841 = 1,131
# Previously: 290  NOTE, 820 + 290 = 1,110
